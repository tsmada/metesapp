...
export const USER_ACCOUNT_DELETE = 'boilerplate/App/USER_ACCOUNT_DELETE';
export const USER_ACCOUNT_DELETE_SUCCESS = 'boilerplate/App/USER_ACCOUNT_DELETE_SUCCESS';
export const USER_ACCOUNT_DELETE_FAILURE = 'boilerplate/App/USER_ACCOUNT_DELETE_FAILURE';
...
export const GET_USER_POOLS = 'boilerplate/App/GET_USER_POOLS';
export const GET_USER_POOLS_SUCCESS = 'boilerplate/App/GET_USER_POOLS_SUCCESS';
export const GET_USER_POOLS_FAILURE = 'boilerplate/App/GET_USER_POOLS_FAILURE';
...
export const LOAD_POOLS = 'boilerplate/App/LOAD_POOLS';
export const LOAD_POOLS_SUCCESS = 'boilerplate/App/LOAD_POOLS_SUCCESS';
export const LOAD_POOLS_FAILURE = 'boilerplate/App/LOAD_POOLS_FAILURE';
export const CREATE_POOL = 'boilerplate/App/CREATE_POOL';
export const CREATE_POOL_SUCCESS = 'boilerplate/App/CREATE_POOL_SUCCESS';
export const CREATE_POOL_FAILURE = 'boilerplate/App/CREATE_POOL_FAILURE';
export const JOIN_POOL = 'boilerplate/App/JOIN_POOL';
export const JOIN_POOL_SUCCESS = 'boilerplate/App/JOIN_POOL_SUCCESS';
export const JOIN_POOL_FAILURE = 'boilerplate/App/JOIN_POOL_FAILURE';
export const LEAVE_POOL = 'boilerplate/App/LEAVE_POOL';
export const LEAVE_POOL_SUCCESS = 'boilerplate/App/LEAVE_POOL_SUCCESS';
export const LEAVE_POOL_FAILURE = 'boilerplate/App/LEAVE_POOL_FAILURE';
